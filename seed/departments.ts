...
export async function seedDepartments(prisma: Prisma.TransactionClient) {
	...
	const departments: Prisma.DepartmentCreateManyInput[] = [
		...
		{
			name: 'Atendimento',
			description: 'Departamento responsável pelo atendimento aos clientes',
			companyId: company.id,
		},
		{
			name: 'Financeiro',
			description: 'Departamento responsável pela gestão financeira da empresa',
			companyId: company.id,
		},
		{
			name: 'Comercial',
		...
		{
			name: 'Engenharia',
			description: 'Departamento técnico e projetos de engenharia da empresa',
			companyId: company.id,
		},
	]
