...
import { listQuery, listResponse, paramsByCnpj } from './schemas'
import type { PrismaClient } from '@prisma/client'

type Resources = { prisma: PrismaClient }

export async function listHistory(app: FastifyInstance, resources: Resources) {
	app
		.withTypeProvider<ZodTypeProvider>()
		.register(auth)
		.get('/api/tenant/:cnpj/conversations', {
			schema: {
				tags: ['Conversation'],
				summary: 'List conversation and AI sessions history',
				params: paramsByCnpj,
